<script>
	...
	var PAGE = {
		...
		cancel: function() {
			if(confirm('{$lang.Addon_reengagement_Schedule_Edit_CancelPrompt}')) {
...
<form method="post" action="{$ApplicationUrl}index.php?Page=Schedule&Action=Update&job={$Jobid}">
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
				{$lang.Addon_reengagement_Schedule_Edit_Heading}
			</td>
		</tr>
		<tr>
			<td class="body pageinfo">
				<p>
					{$lang.Addon_reengagement_Schedule_Edit_Intro}
				</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>
				<input class="FormButton submitButton" type="submit" value="{$lang.Addon_reengagement_Save}" />
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
					<tr>
						<td colspan="2" class="Heading2">
							&nbsp;&nbsp;{$lang.Addon_reengagement_Schedule_Reengagement_Details}
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							...
							{if $SendType == 'list'}
								{$lang.Addon_reengagement_Schedule_MailingLists}
							{else}
								{$lang.Addon_reengagement_Schedule_Segments}
							{/if}
						</td>
						<td>
							{$lang.Addon_reengagement_Schedule_ListIntro}
					...
					<tr>
						<td class="FieldLabel">
							{template="not_required"}
							{$lang.Addon_reengagement_Schedule_SendingNewsletters}&nbsp;
						</td>
						<td>
					...
					<tr>
						<td width="200" class="FieldLabel">
							{template="required"}
							{$lang.Addon_reengagement_Schedule_SendWhen}
						</td>
						<td>
							<input type="hidden" name="sendtime" id="sendtime" value="" />
							{$ScheduleTimeBox}&nbsp;{$lnghlp.Addon_reengagement_Schedule_SendWhen}
						</td>
					</tr>
					<tr>
						<td>
