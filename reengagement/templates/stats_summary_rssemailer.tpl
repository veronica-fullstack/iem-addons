...
<legend>'{$statsDetails.reengagename}' {$lang.Addon_reengagement_Campaign_Statistics}</legend>
	...
	<tr>
		...
		<td>
			<table border="0" width="100%" class="Text" cellspacing="0">
				...
				<tr class="GridRow">
					<td width="30%" height="22" nowrap="nowrap" align="left" valign="top">
						&nbsp;{$lang.Addon_reengagement_SendSize}
					</td>
					<td width="70%" nowrap="nowrap" align="left">
			...
			<tr>
				<td valign="top"	width="100%">
					...
					<tr class="GridRow">
						...
						<th align="center">{$lang.Addon_reengagement_Stats_TotalOpens}</th>
						<th align="center">{$lang.Addon_reengagement_Stats_UniqueOpens}</th>
						<th align="center" style="border-right: 2px solid #EDECEC;">{$lang.Addon_reengagement_Stats_UniqueOpens} (%)</th>
						<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients}</th>
						<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients} (%)</th>
						<th align="center">{$lang.Addon_reengagement_TotalSendSize}</th>
					</tr>
					<tr>
	...
	<table border="0" width="100%">
		...
		<td valign="top" colspan="3"	width="100%">
			...
			<tr class="GridRow">
				...
				<th align="center">{$lang.Addon_reengagement_Stats_UniqueClicks}</th>
				<th align="center">{$lang.Addon_reengagement_Stats_UniqueClicks} (%)</th>
				<th align="center" style="border-right: 2px solid #EDECEC;">{$lang.Addon_reengagement_Stats_TotalClicks}</th>
				<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients}</th>
				<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients} (%)</th>
				<th align="center">{$lang.Addon_reengagement_TotalSendSize}</th>
			</tr>
	...
	<table>
		...
		<td width="100%" valign="top">
			...
			<tr class="GridRow">
				...
				<th align="center" style="border-right: 2px solid #EDECEC;">{$lang.Addon_reengagement_Stats_TotalBounces} (%)</th>
				<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients}</th>
				<th align="center">{$lang.Addon_reengagement_Stats_TotalRecipients} (%)</th>
				<th align="center">{$lang.Addon_reengagement_TotalSendSize}</th>
			</tr>
